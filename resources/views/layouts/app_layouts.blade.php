...
<head>
 ...
 ============================================= -->
    ...
    <link rel="stylesheet" href="{{ asset('common/css/bootstrap.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/style.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/css/dark.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/css/swiper.css') }}" type="text/css" />

    <!-- shop Demo Specific Stylesheet -->
    <link rel="stylesheet" href="{{ asset('common/demos/shop/shop.cs') }}s" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/demos/shop/css/fonts.css') }}" type="text/css" />
    <!-- / -->

    <link rel="stylesheet" href="{{ asset('common/css/font-icons.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/css/animate.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('common/css/magnific-popup.css') }}" type="text/css" />

    <link rel="stylesheet" href="{{ asset('common/css/custom.css') }}" type="text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <link rel="stylesheet" href="{{ asset('common/css/colors.php?color=000000') }}" type="text/css" />
    @yield('css')
    <!-- Document Title
 ============================================= -->
...
<body class="stretched">
            ...
            <div class="card mx-auto" style="max-width: 540px;">
                ...
                <div class="card-body mx-auto py-5" style="max-width: 70%;">
                    ...
                    <form id="login-form" name="login-form" class="mb-0 row" method="POST"
                        ...
                        <div class="col-12">
                            <input placeholder="User Email" id="email" type="email"
                                class="form-control not-dark @error('email') is-invalid @enderror" name="email"
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <input type="password" id="login-form-password" value=""
                                class="form-control not-dark @error('password') is-invalid @enderror"
                        ...
                        <div class="col-12 mt-4">
                            <button type="submit" class="button w-100 m-0" id="login-form-submit"
                        ...
                        <div class="col-12">
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="float-end text-dark fw-light mt-2">Forgot Password?</a>
                            @endif
                        </div>
                    </form>
                                ...
                                <li class="top-links-item"><a href="#">EN</a>
                                    <ul class="top-links-sub-menu">
                                        <li class="top-links-item"><a href="#"><img
                                                    src="common/images/icons/flags/french.png" alt="French"> FR</a>
                                        </li>
                                        <li class="top-links-item"><a href="#"><img
                                                    src="common/images/icons/flags/italian.png" alt="Italian"> IT</a>
                                        </li>
                                        <li class="top-links-item"><a href="#"><img
                                                    src="common/images/icons/flags/german.png" alt="German"> DE</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="top-cart-items">
                                <div class="top-cart-item">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="common/images/shop/small/1.jpg"
                                ...
                                <div class="top-cart-item">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="common/images/shop/small/6.jpg"
                                        ...
                                        <ul class="sub-menu-container mega-menu-column col-lg-3 border-start-0">
                                            <li class="card p-0 bg-transparent border-0">
                                                <img class="card-img-top"
                                                    src="common/demos/shop/images/menu-image.jpg" alt="image cap">
                                                <a href="#"
 ...
 ============================================= -->
    ...
    <script src="{{ asset('common/js/plugins.min.js') }}"></script>
