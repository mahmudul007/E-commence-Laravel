        ...
        <div class="main-icon-menu">
            ...
            <div class="pro-metrica-end">
                <a href="" class="profile">
                    ...
                    @else
                        <img src="{{ Auth::user()->getProfile->link }}" alt="profile-user"
                            class="rounded-circle thumb-sm">
                    @endif
                </a>
            </div>
                ...
                <div id="MetricaApps" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="apps-tab">
                    ...
                    <div class="collapse navbar-collapse" id="sidebarCollapse">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#category" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false" aria-controls="sidebarEcommerce">
                                    Cateory
                                </a>
                                <div class="collapse " id="category">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('category.create.view')}}">Create Category</a>
                                        </li>
                                        <!--end nav-item-->
                                        <li class="nav-item">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="{{route('home')}}"><i
                                class="ti ti-user font-16 me-1 align-text-bottom"></i> Home</a>
                        ...
                        <a class="dropdown-item"
                            ...
                            href="#"><i class="ti ti-power font-16 me-1 align-text-bottom"></i> Logout</a>
                    </div>
